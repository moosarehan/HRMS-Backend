...
public class ShiftController : ControllerBase
{
    ...
    public async Task<IActionResult> GetAll()
    {
        ...
        return Ok(ApiResponse<List<ShiftResponseDto>>.SuccessResponse(result));
    }
    ...
    public async Task<IActionResult> Create(CreateShiftDto dto)
    {
        try
        {
            ...
            return Ok(ApiResponse<ShiftResponseDto>.SuccessResponse(result, "Shift created."));
        }
    ...
    public async Task<IActionResult> Update(int id, UpdateShiftDto dto)
    {
        try
        {
            ...
            return Ok(ApiResponse<ShiftResponseDto>.SuccessResponse(result, "Shift updated."));
        }
    ...
    public async Task<IActionResult> Delete(int id)
    {
        try
        {
            ...
            return Ok(ApiResponse<string>.SuccessResponse("", "Shift deleted successfully."));
        }
        catch (KeyNotFoundException ex)
        {
            return NotFound(ApiResponse<string>.FailResponse(ex.Message));
